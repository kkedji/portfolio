    ...
    <section className="relative min-h-[85vh] flex items-center overflow-hidden px-4 md:px-6 py-10 lg:py-16 bg-background">
      <div className="mx-auto max-w-6xl">
        <motion.div
          ...
          className="relative overflow-hidden rounded-[2rem] border border-border/50 bg-white/40 dark:bg-background/45 p-6 md:p-8 shadow-xl backdrop-blur-3xl"
        >
          ...
          <div className="relative grid gap-8 lg:grid-cols-2">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <motion.h2
                  ...
                  className="text-2xl font-bold tracking-tight text-foreground md:text-4xl leading-tight"
                >
                  Sename Kudjo Kedji, <br />
                  <span className="text-primary font-black">{t('glassmorphism.subtitle')}</span>
                </motion.h2>
                <motion.p
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  ...
                  className="max-w-xl text-base leading-relaxed text-muted-foreground font-medium"
                >
              ...
              <div className="grid gap-3 sm:grid-cols-1">
                {highlights.map((item, index) => (
                  <motion.div
                    ...
                    whileHover={{ y: -4 }}
                    className="group relative overflow-hidden rounded-2xl border border-border/40 bg-white/60 dark:bg-background/60 p-4 backdrop-blur transition-all hover:border-primary/40 hover:shadow-lg hover:shadow-primary/5"
                  >
            ...
            <div className="relative">
              ...
              <div className="relative flex h-full flex-col justify-between overflow-hidden rounded-[28px] border border-border/50 bg-white/50 dark:bg-background/60 p-6 backdrop-blur-xl shadow-xl">
                <div className="flex flex-col items-center text-center">
                  ...
                  >
                    <div className="absolute left-1/2 top-1/2 h-32 w-32 -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary/30 blur-2xl" />
                    <img
                      src="/images/profile.jpg"
                      alt="Sename Kudjo Kedji"
                      className="relative h-32 w-32 rounded-full border-2 border-white/50 object-cover shadow-[0_25px_60px_rgba(15,23,42,0.2)]"
                    />
                  </motion.div>
                  ...
                  <motion.p
                    ...
                    className="mt-4 max-w-sm text-sm font-medium leading-relaxed text-muted-foreground"
                  >
                  ...
                  {socialLinks.map((social) => {
                    ...
                    return (
                      <motion.a
                        ...
                        className="group flex items-center justify-between rounded-2xl border border-border/40 bg-white/80 dark:bg-background/80 px-4 py-2 text-left transition-all hover:-translate-y-0.5 hover:border-primary/50 hover:bg-white dark:hover:bg-background hover:shadow-md"
