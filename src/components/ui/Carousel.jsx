...
function Carousel({
  ...
  // Custom Api support for the GalleryHoverCarousel
  useEffect(() => {
     if (setApi) {
        setApi({
            scrollNext: () => {
                // Implementation requires access to context, managed slightly differently in this component vs standard embla
            },
            scrollPrev: () => {},
            canScrollNext: () => true, // Simplified
            canScrollPrev: () => true, // Simplified
            on: () => {},
            off: () => {}
        });
     }
